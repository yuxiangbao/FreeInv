        ...
        for i, t in enumerate(tqdm(timesteps)):
            for b in range(0, latent_frames.shape[0], batch_size):
                ...
                if self.freeinv:
                    ...
                    angle = random.choice(angle_lst)
                    model_input = TF.rotate(model_input, angle=angle)
                ...
                if self.freeinv:
                    eps = TF.rotate(eps, angle=-angle)  # optional
...
def prep(opt):
    ...
    save_path = os.path.join(opt.save_dir,
                             ...
                             'baseline' if not opt.freeinv else 'freeinv',
...
if __name__ == "__main__":
    ...
    parser.add_argument('--freeinv', action='store_true', default=False)
