...
all_tgt_image_folders={
    ...
    "1_ddpm_edit":"output/ddpm_edit/annotation_images",
    "1_infedit":"output/infedit/annotation_images",
    "1_freeinv+p2p":"output/freeinv+p2p/annotation_images",
    # ---
    ...
    "1_freeinv+masactrl":"output/freeinv+masactrl/annotation_images",
    # ---
    ...
    "1_freeinv+pnp":"output/freeinv+pnp/annotation_images",
    "1_ablation_flip+pnp": "output/ablation_flip+pnp/annotation_images",
    "1_ablation_shuffle+pnp": "output/ablation_shuffle+pnp/annotation_images",
    "1_ablation_ensemble+pnp": "output/ablation_ensemble+pnp/annotation_images",
    "1_ablation_multi_branch+pnp": "output/ablation_multi_branch+pnp/annotation_images",
    # ---
    "1_flux":"output/flux-RF/annotation_images",
    "1_flux+freeinv":"output/flux-RF+freeinv/annotation_images",
    "1_flux+rfsolver": "output/flux-RF+rfsolver/annotation_images",
...
if __name__=="__main__":
    ...
    parser.add_argument('--tgt_methods', nargs = '+', type=str, default=[
                                                                    ...
                                                                    "1_stylediffusion+p2p", "1_directinversion+p2p", "1_freeinv+p2p",
                                                                  ])
    parser.add_argument('--result_path', type=str, default="evaluation_result_recon.csv")
    ...
    for key, item in annotation_file.items():
        ...
        for tgt_image_folder_key,tgt_image_folder in tgt_image_folders.items():
            ...
            for metric in metrics:
                ...
                evaluation_result.append(calculate_metric(metrics_calculator,metric,src_image, tgt_image, np.zeros_like(mask), np.zeros_like(mask), original_prompt, editing_prompt))
